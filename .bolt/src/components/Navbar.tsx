        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-800">SafeVoice</span>
            </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/share-story" className="text-gray-700 hover:text-pink-500 px-3 py-2 rounded-md">Share Story</Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <Link to="/share-story" className="block text-gray-700 hover:text-pink-500 px-3 py-2 rounded-md">Share Story</Link>
